...
class AddUProfileByAdmin extends StatefulWidget {
  AddUProfileByAdmin({required this.user, required this.user_role, super.key});
  ...
  @override
  State<AddUProfileByAdmin> createState() => _AddUProfileByAdminState();
}

class _AddUProfileByAdminState extends State<AddUProfileByAdmin> {
